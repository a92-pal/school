<div class="row" style="margin:4px;">
    ...
    <!-- start change image secion -->
        ...
        <div style="margin:5px 0; display:none; border:1px solid #ccc; padding:5px;" id="image_form" >
            <form action="{{route('student_image')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-12">
...
<!-- end change image section -->
        ...
        <div class="modal fade" id="myModal" role="dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{route('student_password')}}" method="post">
                    @csrf
                        ...
                        <button type="submit" class="btn btn-success" style="float:right; margin:0 10px; outline:none;">Submit</button>
                    </form>
    ...
    <div class="col-md-8">
        <div class="row" style="padding:20px; margin:4px;">
            ...
            <div class="col-md-6">
                <h4><strong>Registration No : </strong> {{$user['reg_no']}}</h4>
            </div>
            <div class="col-md-6">
                <h4><strong>Class : </strong>{{$user['class_section']['class']}}</h4>
            </div>
            <div class="col-md-6">
                <h4><strong>Section : </strong>{{$user['class_section']['section']}} </h4>
            </div>
            <div class="col-md-6">
                <h4><strong>Roll : </strong>{{$user['user_detail']['roll']}} </h4>
            </div>
            ...
            <div class="col-md-12">
                <h4><strong>Address : </strong> {{$user['user_detail']['address']}}</h4>
            </div>
            <div class="col-md-6">
